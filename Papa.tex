...
\hypersetup{unicode=true,
            ...
            pdfauthor={Angelina Vasquez~\& Ernst-August Doelle},
...
\def\footnote{\protect\rmarkdownfootnote}
  ...
  \title{APA Midterm}
    \author{Angelina Vasquez\textsuperscript{1}~\& Ernst-August
...
value p value
tick}\label{apa-print-function-will-make-a-table-of-the-data-you-rananova-table-if-you-write-something-and-then-putr-write-something-other-tick-that-treats-as-r-code-some-this-test-significant-tick-r-f-value-p-value-tick}
